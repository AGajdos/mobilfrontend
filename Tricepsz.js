...
export default class Tricepsz extends React.Component {
  ...
  componentDidMount(){
    return fetch('http://'+IP.ipcim+'/gyakorlatok_tricepsz')
    ...
    return(
      <View style={{ backgroundColor:"#DCF9F4"}}>
        <FlatList
          ...
          <Image  source={{uri: 'http://'+IP.ipcim+'/'+item.gyakorlat_kep}} style={{width:370,height:300,marginLeft:"auto",marginRight:"auto"}} />  
